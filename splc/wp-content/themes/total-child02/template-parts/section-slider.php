		...
		if($total_slider_page_id){
			...
			if( $query->have_posts() ):
				...
				$custom_fields = get_post_custom();
  				$custom_link = $custom_fields['custom_link_slide'];
				...
				<div class="ht-slide">
					...
					<div class="ht-slide-caption">
						<?php echo ($custom_link?'<a href="'.$custom_link[0].'">':'');?><div class="ht-slide-cap-title animated fadeInDown">
							<span><?php echo esc_html(get_the_title()); ?></span>
						</div><?php echo ($custom_link?'</a>':'')?>
