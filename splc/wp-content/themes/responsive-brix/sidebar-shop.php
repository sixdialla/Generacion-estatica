		...
		elseif ( current_user_can( 'edit_theme_options' ) ) : // If the sidebar has no widgets.
			...
			the_widget(
				...
				array(
					...
					'text'   => sprintf( __( 'Woocommerce pages have a separate sidebar than the rest of your site. You can add custom widgets from the %swidgets screen%s in wp-admin.', 'responsive-brix' ), '<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '">', '</a>' ),
					'filter' => true,
				),
				array(
