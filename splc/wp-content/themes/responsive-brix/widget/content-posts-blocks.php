...
do_action( 'hoot_content_blocks_wrap', 'posts' );
?>
...
<div class="content-blocks-widget-wrap content-blocks-posts <?php echo sanitize_html_class( $top_class ); ?>">
	<div class="content-blocks-widget-box <?php echo sanitize_html_class( $bottom_class ); ?>">
		<div class="content-blocks-widget <?php echo sanitize_html_class( 'content-blocks-widget-' . $style ); ?>" <?php echo $custommargin; ?>>
			...
			// Template modification Hook
			do_action( 'hoot_content_blocks_start', 'posts' );
			?>
			...
			<div class="flush-columns">
				<?php
						...
						foreach( $content_blocks_query as $post ) :
								...
								<div class="content-block-column <?php echo "column-1-{$columns} content-block-{$counter}"; $counter++; ?> <?php echo sanitize_html_class( 'content-block-' . $style ); ?>">
									<?php
									$block_class = ( !$has_image ) ? 'no-highlight' : ( ( $style == 'style2' ) ? 'highlight-typo' : '' );
									?>
			...
			<?php
			// Template modification Hook
			do_action( 'hoot_content_blocks_end', 'posts' );
			?>
