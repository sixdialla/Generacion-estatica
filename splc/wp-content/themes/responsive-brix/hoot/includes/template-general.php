...
function hoot_get_loop_description() {
	...
	elseif ( is_search() ) {
		...
		$loop_desc = sprintf( __( 'You are browsing the search results for &#8220;%s&#8221;', 'responsive-brix' ), $search_query );
...
function hoot_search_title( $prefix = '', $display = true ) {
	...
	$title = $prefix . sprintf( __( 'Search results for &#8220;%s&#8221;', 'responsive-brix' ), $search_query );
