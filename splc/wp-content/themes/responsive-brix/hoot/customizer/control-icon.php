	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customizer-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="fa <?php echo esc_attr( $this->value() ) ?>"></i><span><?php _e( 'Select Icon', 'responsive-brix' ) ?></span></div>
				<div class="hoot-customizer-control-icon-remove"><i class="fa fa-ban"></i><span><?php _e( 'Remove Icon', 'responsive-brix' ) ?></span></div>
	...
	<div id="hoot-flyicon" class="hoot-flypanel">
		<div class="hoot-flypanel-header hoot-flypanel-nav">
			<div class="primary-actions">
				<span class="hoot-flypanel-back" tabindex="-1"><span class="screen-reader-text"><?php _e( 'Back', 'responsive-brix' ) ?></span></span>
			</div>
		</div>
