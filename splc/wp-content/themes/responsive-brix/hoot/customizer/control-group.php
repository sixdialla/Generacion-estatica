...
class Hoot_Customize_Group_Control extends WP_Customize_Control {
	...
	protected function render() {
		...
		$class = 'customize-control customize-control-' . $this->type . ' hoot-customize-control-' . $this->type . $this->group . ' hoot-control-id-' . $this->identifier;
			...
			case 'group' :
				...
				switch ( $this->group ) {
					...
					case 'start' :
						...
						$button = empty( $this->button ) ? __( 'Edit Group', 'responsive-brix' ) : $this->button;
						?>
