...
Tags: youtube, responsive, widget, autoplay, youtube embed, youtube plugin, embed youtube, embedding youtube, seo youtube, no-cookie, youtube plugin, youtube visual composer, sidebar, simple youtube, annotations, wordpress youtube widget, wordpress youtube embed, video plugin, video widget, shortcode youtube, shortcode, youtube schema.org, youtube schemaorg, youtube schema.org/VideoObject, youtube schema.org VideoObject
Requires at least: 3.0.1
Tested up to: 4.7.3
Stable tag: 1.4.1
License: GPLv2 or later

Widgets + ShortCode responsive to embed youtube in your sidebar or in your content [youtube video=...] or in visual composer, with SEO http://schema.org/VideoObject fields.
Share your channel with YouTube button subscribe.

== Description ==

Widgets + ShortCode responsive to embed youtube in your sidebar or in your content [youtube video=...] or in visual composer, with all available options and http://schema.org/VideoObject fields.
...
Upload the Youtube Widget Responsive plugin to your blog, Activate it, Add in your sidebar from Widgets OR put in the content [youtube video=link_youtube] or in visual composer.
